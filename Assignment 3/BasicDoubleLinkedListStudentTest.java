...
public class BasicDoubleLinkedListStudentTest {
	...
	public Car a=new Car("Apple", "Red", 2001);
	public Car b=new Car("Banana", "Yellow", 2001);
	public Car c=new Car("Cherry", "Red", 2001);
	public Car d=new Car("Mango", "Yellow", 2001);
	public Car e=new Car("Pear", "Green", 2001);
	public Car f=new Car("Peach", "Pink", 2001);
	...
	public void testAddToFront() {
		...
		linkedString.addToFront("Beginning");
		assertEquals("Beginning", linkedString.getFirst());
	...
	public void testGetFirst() {
		assertEquals("Start", linkedString.getFirst());
		linkedString.addToFront("Fresh");
		assertEquals("Fresh", linkedString.getFirst());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Fresh", iterator.next());
		assertEquals("Start", iterator.next());
		assertEquals("End", iterator.next());
		assertEquals(true, iterator.hasNext());
		assertEquals("New", iterator.next());
...
//	}
	...
	public void testRetrieveFirstElement() {
		...
		linkedString.addToFront("Fresh");
		assertEquals("Fresh", linkedString.getFirst());
		assertEquals("Fresh", linkedString.retrieveFirstElement());
		assertEquals("Start",linkedString.getFirst());
		assertEquals("Start", linkedString.retrieveFirstElement());
		assertEquals("End",linkedString.getFirst());
