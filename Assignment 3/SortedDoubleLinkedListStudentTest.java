...
public class SortedDoubleLinkedListStudentTest {
	...
	public Car a=new Car("ABC", "red", 2005);
	public Car b=new Car("DEF", "Blue", 2005);
	public Car c=new Car("GHI", "green", 2005);
	public Car d=new Car("JKL", "yellow", 2005);
	public Car e=new Car("MNO", "silver", 2005);
	public Car f=new Car("PQR", "orange", 2005);
